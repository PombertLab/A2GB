...
To generate tab-delimited lists of tRNAs/rRNAs, we can use [get_RNA_locus_tags.pl](https://github.com/PombertLab/A2GB/blob/master/Function_prediction/get_RNA_locus_tags.pl):
